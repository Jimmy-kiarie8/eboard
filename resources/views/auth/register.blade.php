            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="credentials" class="col-md-4 col-form-label text-md-right">credentials</label>
                        ...
                        <div class="form-group row">
                            <label for="credentials" class="col-md-4 col-form-label text-md-right">Company</label>
